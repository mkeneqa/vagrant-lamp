...
debconf-set-selections <<< 'mysql-server mysql-server/root_password password root4mysql'
debconf-set-selections <<< 'mysql-server mysql-server/root_password_again password root4mysql'
